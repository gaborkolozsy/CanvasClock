 ...
 * @see SVGPath
 */
public final class ClockIcon extends HBox {
    ...
    private void buildIcon() {        
        ...
        svgPath.autosize(); 
        svgPath.setFill(Color.rgb(46, 96, 255));
        
        StackPane iconLayers = new StackPane();
        iconLayers.setOpacity(.70);
        iconLayers.getChildren().add(svgPath);
        iconLayers.setCacheHint(CacheHint.SPEED);

        group.getChildren().add(iconLayers);
